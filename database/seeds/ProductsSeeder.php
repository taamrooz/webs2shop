...
class ProductsSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('products')->insert([
            ...
            'prijs' => '2.05',
            'imageurl' => 'products/asplenium-trichomanes.jpg',
        ]);
        DB::table('products')->insert([
            'category_id' =>  1,
            ...
            'prijs' => '2.75',
            'imageurl' => 'products/bergenia-silberlicht.jpg',
        ]);
        DB::table('products')->insert([
            'category_id' =>  2,
            ...
            'prijs' => '1.35',
            'imageurl' => 'products/lavandula-angustifolia-alba.jpg',
        ]);
        DB::table('products')->insert([
            'category_id' =>  2,
            ...
            'prijs' => '1.15',
            'imageurl' => 'products/lavandula-angustifolia-munstead.jpg',
        ]);
        DB::table('products')->insert([
            'category_id' =>  1,
            ...
            'prijs' => '1.80',
            'imageurl' => 'products/brunnera-macrophylla.jpg',
        ]);
        DB::table('products')->insert([
            'category_id' =>  3,
            ...
            'prijs' => '2.05',
            'imageurl' => 'products/dryopteris-erythrosora.jpg',
        ]);
        DB::table('products')->insert([
            'category_id' =>  1,
            ...
            'prijs' => '2.50',
            'imageurl' => 'products/darmera-peltata.jpg',
        ]);
        DB::table('products')->insert([
            'category_id' =>  3,
            ...
            'prijs' => '2.05',
            'imageurl' => 'products/osmunda-regalis.jpg',
        ]);
    }
}
